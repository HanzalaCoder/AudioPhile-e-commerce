    ...
    return (
        <section className="w-[90%] mx-auto md:max-w-[80%]">
              <nav className="grid place-items-center grid-cols-1 md:grid-cols-3   my-[6rem] md:my-[10rem] gap-[5rem]">
                <Link to="/headphones" className=" w-[380px] md:w-[230px] lg:w-[300px] xl:w-[380px]   h-[200px] md:h-[180px] lg:h-[200px]  bg-zinc-300/50 rounded-lg  shadow-lg  grid place-items-center relative ">
                ...
                <Link to="/speakers" className=" w-[380px] md:w-[230px] lg:w-[300px]  xl:w-[380px]     h-[200px] md:h-[180px] lg:h-[200px]   bg-zinc-300/50 rounded-lg  shadow-lg  grid place-items-center relative ">
                ...
                <Link to="/earphones" className=" w-[380px] md:w-[230px] lg:w-[300px] xl:w-[380px]      h-[200px] md:h-[180px] lg:h-[200px]   bg-zinc-300/50 rounded-lg  shadow-lg  grid place-items-center relative ">
