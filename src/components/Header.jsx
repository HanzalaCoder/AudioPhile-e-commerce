        ...
        <header className="bg-almostBlack pb-4 pt-4 z-50" >
            <section className=" flex items-center mx-auto w-[90%] py-6 md:max-w-[80%]">
                ...
                <div className="ml-auto relative cursor-pointer z-50 ">
                    ...
                    <div className={`cartTotal bg-darkorange  text-customwhite rounded-full place-items-center absolute w-[20px] -top-5 -right-2 ${arrayData.length === 0 ? "hidden": "grid"}`}>{cartTotalState.count}</div>
                    <Cart data = {data} />
                </div>
            </section>
